...
//			xCount1++;
//			xCount.setText(String.valueOf(false));
//		}
//		
...
//	oCount1++;
//	oCount.setText(String.valueOf(false));
//}
//
...
//					
//				}else {
//					btn6.setForeground(Color.blue);	 b6=0;	i++;
//				}
//				choosePlayer(); winningGame();
//			}
//		});
...
//		
//		JLabel lblNewLabel_1 = new JLabel("   Player Y");
...
//				if(startGame.equalsIgnoreCase("X")) {
//					
//				btn7.setForeground(Color.red); b7=1; i++;
//					
//				}else {
//					btn7.setForeground(Color.blue);		b7=0; i++;
//				}
//				choosePlayer();  winningGame();
//			}
//		});
